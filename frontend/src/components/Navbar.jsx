...
const Navbar = () => {
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem('userWorkflows');
    setUser(null);
    setIsDropdownOpen(false);
    window.location.reload();
  };
  ...
  const isLoggedIn = user && (user.email || user.username);
        ...
        <div className="flex items-center space-x-4">
          ...
          {isLoggedIn ? (
            <div className="relative" ref={dropdownRef}>
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                  ...
                  <div className= "border-gray-100 mt-1">
                    <button 
            ...
            <button 
              ...
              className='text-lg border rounded-full bg-green-600 hover:bg-green-700 text-white px-6 py-2 cursor-pointer transition-colors font-medium'
            >
              Login
            </button>
          )}
